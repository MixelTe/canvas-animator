...
const styles = {
	fill: (ctx: CanvasRenderingContext2D) => { ctx.fillStyle = "aquamarine"; },
	stroke: (ctx: CanvasRenderingContext2D) => { ctx.strokeStyle = "darkblue"; },
	stroke2: (ctx: CanvasRenderingContext2D) => { ctx.strokeStyle = "darkblue"; ctx.lineWidth = 2;},
	text: (ctx: CanvasRenderingContext2D) => { ctx.font = "30px Arial"; },
	shadow: [
