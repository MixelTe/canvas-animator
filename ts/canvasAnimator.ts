...
export class CanvasAnimator
{
	...
	private createCircleAnimationGrow(startTime: number, time: number, startAngle: number, reverse?: boolean)
	{
		return new CanvasAnimator_CircleAnimationData_Grow(startTime, time, startAngle, reverse);
	}
	private createCircleAnimationFold(startTime: number, time: number, startAngle: number, reverse?: boolean)
	{
		return new CanvasAnimator_CircleAnimationData_Fold(startTime, time, startAngle, reverse);
	}
